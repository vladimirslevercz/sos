<?php
// source: /Users/vml/Zend/workspaces/DefaultWorkspace11/sos/app/FrontModule/templates/@layout.latte

class Templatead32dd9ad17714d8458b0639081d8b86 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('94356a3414', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb3c241c2295_scripts')) { function _lb3c241c2295_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>    <!-- jQuery -->
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb1943554950_content')) { function _lb1943554950_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
